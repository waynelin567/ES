...
int main(void) {
  ...
  uint32_t start_toggleID0 = virtual_timer_start(1000000, led0_toggle);
  uint32_t start_toggleID1 = virtual_timer_start(2000000, led1_toggle);
  uint32_t start_toggleID2 = virtual_timer_start(3000000, led2_toggle);

  uint32_t end_toggleID0 = virtual_timer_start(4000000, led0_toggle);
  uint32_t end_toggleID1 = virtual_timer_start(5000000, led1_toggle);
  uint32_t end_toggleID2 = virtual_timer_start(6000000, led2_toggle);
